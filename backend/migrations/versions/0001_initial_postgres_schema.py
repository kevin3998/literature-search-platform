...
def upgrade() -> None:
    ...
    op.create_table("conversation_artifact_links", sa.Column("session_id", UUID, sa.ForeignKey("sessions.session_id", ondelete="CASCADE"), nullable=False), sa.Column("turn_id", UUID, nullable=True), sa.Column("artifact_id", UUID, sa.ForeignKey("artifacts.artifact_id", ondelete="CASCADE"), nullable=False), sa.Column("link_type", sa.Text(), nullable=False), _ts("created_at"), sa.PrimaryKeyConstraint("session_id", "artifact_id", "link_type", name="pk_conversation_artifact_links"))
