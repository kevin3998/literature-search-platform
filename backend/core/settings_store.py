...
class SettingsStore:
    ...
    def agent_config(self, *, user_id: str | None = None) -> dict[str, Any]:
        return {
            ...
            "max_tool_iterations": _positive_int(self.value("agent", "max_tool_iterations", user_id=user_id), 6),
            "tool_budget": _positive_int(self.value("agent", "tool_budget", user_id=user_id), 12),
